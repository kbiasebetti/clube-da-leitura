...
namespace ClubeDaLeitura.ModuloRevistas
{
    public class TelaRevista : TelaBase
    {
        ...
        public TelaRevista(RepositorioRevista repositorioRevista, RepositorioCaixa repositorioCaixa, Notificador notificador)
            : base("Revista", repositorioRevista, notificador)
        {
